<h1 align="center">⌨️ Thai Keyboard · แป้นพิมพ์ไทย</h1>

<p align="center">
  <b>Press <kbd>Esc</kbd> to switch TH ⇄ EN · กด <kbd>Esc</kbd> เพื่อสลับภาษา</b>
</p>

<p align="center">
  <a href="https://3bbthailand.github.io/thai-keyboard-web/thai-keyboard_1.html">
    <b>▶ Live Demo · ทดลองใช้งาน</b>
  </a>
</p>
...
- **<kbd>Esc</kbd> to switch TH ⇄ EN** instantly — one key, both worlds
...
| Action | What to do |
| --- | --- |
| **Switch TH ⇄ EN** | Press <kbd>Esc</kbd>, click the TH / EN toggle, or click the on-screen `esc ⇄` key |
...
- **กด <kbd>Esc</kbd> เพื่อสลับภาษา TH ⇄ EN** ได้ในปุ่มเดียว
...
| --- | --- |
| **สลับภาษา TH ⇄ EN** | กด <kbd>Esc</kbd>, คลิกปุ่ม TH / EN, หรือคลิกปุ่ม `esc ⇄` บนแป้น |
